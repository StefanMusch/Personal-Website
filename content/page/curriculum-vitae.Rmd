...
<li><i class="fa fa-dashboard  fa-lg"></i>  **FlexDashboard: Economische Verkenning Rotterdam 2018 (EVR)**</li>
...
<li><i class="fa fa-dashboard  fa-lg"></i> **Shiny App: Real Estate Navigator** </li>
...
<ul style="list-style-type:none">
<li><i class="fa fa-spinner  fa-lg"></i>  **Data Science & Business Analytics** *(VU | 2017 - Present)*</li>
<li><i class="fa fa-graduation-cap  fa-lg"></i>  **MSc Master Marketing & Management** *(Tilburg University | 2016 - 2017)*</li>
</ul>
...
<br>
<ul style="list-style-type:none">
<li><i class="fa fa-graduation-cap  fa-lg"></i>  **MSc Pre-Master Marketing & Management** *(Tilburg University | 2015)*</li>
...
<ul style="list-style-type:none">
<li><i class="fa fa-spinner  fa-lg"></i>   **Rotterdam Municipality** | *Data Science Trainee (2017 - Present)* </li>
